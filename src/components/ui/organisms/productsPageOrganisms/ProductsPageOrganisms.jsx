...
function ProductsPageOrganisms() {
        ...
        <div className="w-full h-auto flex items-center justify-center flex-col">
            <div className="md:w-[1350px] h-auto flex flex-col md:gap-5">
                <div className="w-full md:h-[100px] flex items-center md:gap-5">
                    ...
                    <P className='text-[18px]'>Shop All</P>
                </div>
            </div>
            <Image src='/assets/images/shopAllPic.png' className='w-full md:h-[660px]' />
...
export default ProductsPageOrganisms;